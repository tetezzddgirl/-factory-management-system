...
interface Props {
  ...
  /** รายชื่อสายการผลิตจริงจาก backend (/api/production-lines) — ถ้ายังโหลดไม่เสร็จ/ว่าง จะ fallback เป็นรายการตัวอย่างแทน */
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
          <Stack spacing={2}>
            <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
              <TextField fullWidth label="หมายเลขใบสั่งผลิต" value={v.orderNo} slotProps={{ input: { readOnly: true } }} helperText="ระบบกำหนดให้อัตโนมัติ" />
