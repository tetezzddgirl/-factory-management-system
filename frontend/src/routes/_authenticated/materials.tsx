...
import { materialsApi, materialLocationsApi, materialRecordsApi, workOrdersApi, employeesApi, employeeFullName, employeeOptions, productsApi, formulasApi, computeRequiredMaterials, resolveHandlerName, type ApiRawMaterial, type ApiRawMaterialRecord, type ApiRawMaterialLocation, type ApiWorkOrder, type ApiEmployee, type ApiProduct, type ApiFormulaItem } from "@/lib/api-client";
...
function MaterialsPage() {
  ...
  const currentHandler = currentWarehouse
    ? `${currentWarehouse.employeeId} — ${employeeFullName(currentWarehouse)}` : "";
