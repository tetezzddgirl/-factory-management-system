...
import {
  wipApi, wipLocationsApi, wipRecordsApi, requisitionsApi, workOrdersApi, employeesApi, employeeFullName, employeeOptions,
  type ApiWorkInProcess, type ApiWipRecord, type ApiRequisitionSlip, type ApiWipLocation, type ApiWorkOrder, type ApiEmployee,
} from "@/lib/api-client";
