...
import {
  machinesApi, productionLinesApi, employeesApi, workApi,
  type ApiMachine, type ApiMachineJob, type ApiMachineType, type ApiEmployee,
...
function MachinesPage() {
  ...
  const [owners, setOwners] = useState<ApiEmployee[]>([]);
