...
function QualityPage() {
  ...
  const [fgTotals, setFgTotals] = useState<Record<string, number>>({}); // เก็บผลรวม FG
  ...
  return (
    <PageShell
      title="ควบคุมคุณภาพ"
      description="ติดตามผลการตรวจสอบคุณภาพและเลือกรายการผลิตเพื่อจัดการรายละเอียด"
      icon={<VerifiedUser />}
    >
      {error && (
